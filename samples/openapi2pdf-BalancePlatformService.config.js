...
module.exports = {
    template: "hurraycola",
    openapiJsonPath: "https://api.apis.guru/v2/specs/adyen.com/BalancePlatformService/2/openapi.json", // BalancePlatformService
    metadata:{
    ...
    outputFiles: {
        pdf: "BalancePlatformService-hurraycola.pdf",
        html: "BalancePlatformService-hurraycola.html"
    }
}